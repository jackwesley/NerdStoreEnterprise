    ...
    public class PedidoQueries : IPedidoQueries
    {
        ...
        public async Task<PedidoDTO> ObterUltimoPedido(Guid clienteId)
        {
            const string sql = @"SELECT
                               ...
                               P.LOGRADOURO, P.NUMERO, P.BAIRRO, P.CEP, P.COMPLEMENTO, P.CIDADE, P.ESTADO, PIT.ID AS 'ProdutoItemID', PIT.PRODUTONOME, PIT.QUANTIDADE, PIT.PRODUTOIMAGEM, PIT.VALORUNITARIO
                               FROM PEDIDOS P
            ...
            var pedido = await _pedidoRepository.ObderConexao()
