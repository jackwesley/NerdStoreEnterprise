...
namespace NSE.Pedidos.Infra.Data.Repository
{
    public class PedidoRepository : IPedidoRepository
    {
        ...
        public Core.Data.IUnitOfWork UnitOfWork => _context;
        ...
        public async Task<IEnumerable<Pedido>> ObterListaPorClienteId(Guid clientId)
        {
            return await _context.Pedidos
                .Include(p => p.PedidoItems)
                .AsNoTracking().Where(p => p.ClienteId == clientId)
                .ToListAsync();
        }
        ...
        public DbConnection ObderConexao() => _context.Database.GetDbConnection();        
    }
}
