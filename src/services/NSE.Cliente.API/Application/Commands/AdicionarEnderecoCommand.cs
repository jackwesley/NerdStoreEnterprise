        ...
        public class EnderecoValidation : AbstractValidator<AdicionarEnderecoCommand>
        {
            public EnderecoValidation()
            {
                RuleFor(c => c.Logradouro)
                    .NotEmpty()
                    .WithMessage("Infomr o Logradouro");

                RuleFor(c => c.Numero)
                    .NotEmpty()
                    .WithMessage("Infomr o Numero");

                RuleFor(c => c.Cep)
                    .NotEmpty()
                    .WithMessage("Infomr o Cep");

                RuleFor(c => c.Bairro)
                    .NotEmpty()
                    .WithMessage("Infomr o Bairro");

                RuleFor(c => c.Cidade)
                    .NotEmpty()
                    .WithMessage("Infomr a Cidade");

                RuleFor(c => c.Estado)
                    .NotEmpty()
                    .WithMessage("Infomr o Estado");
            }
        }
    }
}
